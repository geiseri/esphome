...
static const uint8_t PROGMEM INITCMD_ST7789V2[] = {
    ...
    ILI9XXX_PIXFMT, 1, 0x05,  // COLMOD  (3ah): Interface Pixel Format (16bpp)
    ...
    ILI9XXX_PWCTR3, 1, 0x01, // VDVVRHEN (C2h): VDV and VRH Command Enable
    ILI9XXX_PWCTR4, 1, 0x0d, // VRHS (C3h): VRH Set
    ILI9XXX_PWCTR5, 1, 0x20, // VDVS (C4h): VDV Set
